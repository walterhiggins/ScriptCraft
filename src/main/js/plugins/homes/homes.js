...
var homes = plugin('homes', {
    help: function() {
        return [
            /* basic functions */
            '/jsp home : Return to your own home', '/jsp home {player} : Go to player home', '/jsp home set : Set your current location as home', '/jsp home delete : Delete your home location',
            /* social */
            '/jsp home list : List homes you can visit', '/jsp home ilist : List players who can visit your home', '/jsp home invite {player} : Invite {player} to your home', '/jsp home uninvite {player} : Uninvite {player} to your home', '/jsp home public : Open your home to all players', '/jsp home private : Make your home private',
            /* administration */
            '/jsp home listall : Show all houses (ops only)', '/jsp home clear {player} : Clears player home location (ops only)'
        ];
    },
    /* ========================================================================
     basic functions
...
var options = {
    ...
    'list': function(params, sender) {
        ...
        if(visitable.length == 0) {
            ...
            echo(sender, ['You can visit any of these ' + visitable.length + ' homes', visitable.join(', ')]);
        }
    },
    'ilist': function(params, sender) {
        ...
        if(potentialVisitors.length == 0) {
            ...
            echo(sender, ['These ' + potentialVisitors.length + 'players can visit your home',
