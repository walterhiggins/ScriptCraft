...
3. Open a terminal (Mac and Linux) or command prompt (windows) window and type `java -jar BuildTools.jar --rev 1.10.2`. This will kick off a long series of commands to "build" SpigotMC.
